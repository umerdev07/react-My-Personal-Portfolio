...
import MiniSkillCategoryCard from "../../componets/Section3Components/MiniSkillCategoryCards";
    ...
    <section className="w-full py-20">
      ...
      <div className="mt-8 text-center">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg text-gray-400 p-5">
          ...
          modern web, mobile, and AI-powered applications.
        </p>
      </div>
      ...
      {/* Skill Cards */}
      <div className="mt-8 m-5 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <br />
      <br />
      <div className="w-full h-px bg-gray-400/20 mt-10 mb-6" />

<div className="flex justify-center">
  <MiniSkillCategoryCard />
</div>
    </section>
  );
};
